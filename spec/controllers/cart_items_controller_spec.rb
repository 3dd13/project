  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved cart_item as @cart_item" do
        ...
        post :create, {:cart_item => { "product_id" => "invalid value" }}, valid_session
        assigns(:cart_item).should be_a_new(CartItem)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested cart_item" do
        ...
        CartItem.any_instance.should_receive(:update).with({ "product_id" => "1" })
        put :update, {:id => cart_item.to_param, :cart_item => { "product_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the cart_item as @cart_item" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        CartItem.any_instance.stub(:save).and_return(false)
        put :update, {:id => cart_item.to_param, :cart_item => { "product_id" => "invalid value" }}, valid_session
        assigns(:cart_item).should eq(cart_item)
      end
